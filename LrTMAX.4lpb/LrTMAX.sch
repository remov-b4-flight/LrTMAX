...
U 1 1 5C490EFE
P 8000 1950
F 0 "C40" H 8115 1996 50  0000 L CNN
F 1 "10n" H 8115 1905 50  0000 L CNN
...
F 1 "10n" V 8950 1350 50  0000 C CNN
...
U 1 1 5C49B5B9
P 12500 1100
F 0 "J1" H 12555 1567 50  0000 C CNN
F 1 "USB_B_Micro" H 12555 1476 50  0000 C CNN
F 2 "LrE-6:USB_Micro-B_MCUBF-09_1" H 12650 1050 50  0001 C CNN
...
U 1 1 5C49BFE9
P 13650 2850
F 0 "J2" H 13550 3400 50  0000 L CNN
F 1 "SM06B-SRSS-TB" H 13550 3300 50  0000 L CNN
F 2 "Connector_JST:JST_SH_SM06B-SRSS-TB_1x06-1MP_P1.00mm_Horizontal" H 13650 2850 50  0001 C CNN
...
U 1 1 5C4A8121
P 12500 1650
F 0 "#PWR0110" H 12500 1400 50  0001 C CNN
...
Wire Wire Line
	13450 2750 12900 2750
Wire Wire Line
	12900 2750 12900 2150
$Comp
...
F 3 "" H 15650 850 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text Label 12350 2650 0    50   ~ 0
NRST
Wire Wire Line
	13450 3050 12800 3050
Wire Wire Line
	13450 2950 12800 2950
...
U 1 1 5C4ACA20
P 12050 2050
F 0 "#PWR0112" H 12050 1900 50  0001 C CNN
F 1 "+3V3" H 12065 2223 50  0000 C CNN
...
Wire Wire Line
	12900 2150 12050 2150
Wire Wire Line
	12050 2650 12050 2500
Connection ~ 12050 2650
Wire Wire Line
	13450 2650 12050 2650
Wire Wire Line
...
U 1 1 5C4ACBA6
P 12050 3100
F 0 "#PWR0113" H 12050 2850 50  0001 C CNN
...
U 1 1 5C4ACB2C
P 12050 2350
F 0 "R47" H 12120 2396 50  0000 L CNN
F 1 "10K" H 12120 2305 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 11980 2350 50  0001 C CNN
...
U 1 1 5C4ACA82
P 12050 2900
F 0 "C53" H 12165 2946 50  0000 L CNN
F 1 "1u" H 12165 2855 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 12088 2750 50  0001 C CNN
...
F 1 "10n" H 15250 1150 50  0000 C CNN
...
U 1 1 5D024220
P 10300 3800
F 0 "R46" H 10370 3846 50  0000 L CNN
...
U 1 1 5D54B231
P 1200 10300
F 0 "C30" H 950 10350 50  0000 L CNN
F 1 "0.1u" H 950 10250 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 1238 10150 50  0001 C CNN
...
Wire Wire Line
	1600 10950 1200 10950
Wire Wire Line
	1200 10950 1200 10450
Wire Wire Line
	800  10600 1300 10600
Wire Wire Line
	800  10150 1200 10150
Wire Wire Line

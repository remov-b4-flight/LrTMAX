...
const uint8_t LED_Scene[SCENE_COUNT][LED_COUNT] = {
	...
	{LED_OFF,	LED_OFF,	LED_OFF,	LED_OFF,	LED_OFF,	LED_OFF,	LED_OFF,	LED_OFF	},	//Scene2
...
/*C41*/	{.axis = 1,	.color = LED_GREEN,		.period = LED_TIM_NORM},	//enc1 CW
		{.axis = 1,	.color = LED_DARKGREEN,	.period = LED_TIM_SHORT},	//enc1 CCW
/*C42*/	{.axis = 2,	.color = LED_BLUE,		.period = LED_TIM_NORM},	//enc2 CW
		{.axis = 2,	.color = LED_DARKBLUE,	.period = LED_TIM_SHORT},	//enc2 CCW
/*C43*/	{.axis = 3,	.color = LED_YELLOW,	.period = LED_TIM_NORM},	//enc3 CW
		{.axis = 3,	.color = LED_DARKYELLOW,.period = LED_TIM_SHORT},	//enc3 CCW
/*C44*/	{.axis = 4,	.color = LED_CYAN,		.period = LED_TIM_NORM},	//enc4 CW
		{.axis = 4,	.color = LED_DARKCYAN,	.period = LED_TIM_SHORT},	//enc4 CCW
/*C45*/	{.axis = 5,	.color = LED_ORANGE,	.period = LED_TIM_NORM},	//enc5 CW
		{.axis = 5,	.color = LED_DARKORANGE,.period = LED_TIM_SHORT},	//enc5 CCW
/*C46*/	{.axis = 6,	.color = LED_WHITE,		.period = LED_TIM_NORM},	//enc6 CW
		{.axis = 6,	.color = LED_DARK,		.period = LED_TIM_SHORT},	//enc6 CCW
/*C47*/	{.axis = 7,	.color = LED_WHITE,		.period = LED_TIM_NORM},	//enc7 CW
		{.axis = 7,	.color = LED_DARK,		.period = LED_TIM_SHORT},	//enc7 CCW
	},{	//Scene1 switches/encoders push	(Local Edits)
...
/*C58*/	{.axis = 2,	.color = LED_GLAY,		.period = LED_TIM_NORM},	//enc2 CW
		{.axis = 2,	.color = LED_DARK,		.period = LED_TIM_HALF},	//enc2 CCW
/*C59*/	{.axis = 3,	.color = LED_GLAY,		.period = LED_TIM_NORM},	//enc3 CW
		{.axis = 3,	.color = LED_DARK,		.period = LED_TIM_HALF},	//enc3 CCW
/*C60*/	{.axis = 4,	.color = LED_GLAY,		.period = LED_TIM_NORM},	//enc4 CW
		{.axis = 4,	.color = LED_DARK,		.period = LED_TIM_HALF},	//enc4 CCW
...
/*C63*/	{.axis = 7,	.color = LED_GLAY,		.period = LED_TIM_NORM},	//enc7 CW
	...
	},{	//Scene2 switches/encoders push	(Basic Edits)
...
/*C49*/	{.axis = 1,	.color = LED_YELLOW,	.period = LED_TIM_NORM},	//enc1 CW
		{.axis = 1,	.color = LED_BLUE,		.period = LED_TIM_SHORT},	//enc1 CCW
/*C50*/	{.axis = 2,	.color = LED_MAGENTA,	.period = LED_TIM_NORM},	//enc2 CW
		{.axis = 2,	.color = LED_GREEN,		.period = LED_TIM_SHORT},	//enc2 CCW
/*C51*/	{.axis = 3,	.color = LED_WHITE,		.period = LED_TIM_NORM},	//enc3 CW
		{.axis = 3,	.color = LED_GLAY,		.period = LED_TIM_SHORT},	//enc3 CCW
/*C52*/	{.axis = 4,	.color = LED_WHITE,		.period = LED_TIM_NORM},	//enc4 CW
		{.axis = 4,	.color = LED_GLAY,		.period = LED_TIM_SHORT},	//enc4 CCW
...
/*C65*/	{.axis = 1,	.color = LED_RED,		.period = LED_TIM_NORM},	//enc1 CW
		{.axis = 1,	.color = LED_DARKRED,	.period = LED_TIM_SHORT},	//enc1 CCW
/*C66*/	{.axis = 2,	.color = LED_ORANGE,	.period = LED_TIM_NORM},	//enc2 CW
		{.axis = 2,	.color = LED_DARKORANGE,.period = LED_TIM_SHORT},	//enc2 CCW
/*C67*/	{.axis = 3,	.color = LED_YELLOW,	.period = LED_TIM_NORM},	//enc3 CW
		{.axis = 3,	.color = LED_DARKYELLOW,.period = LED_TIM_SHORT},	//enc3 CCW
/*C68*/	{.axis = 4,	.color = LED_GREEN,		.period = LED_TIM_NORM},	//enc4 CW
		{.axis = 4,	.color = LED_DARKGREEN,	.period = LED_TIM_SHORT},	//enc4 CCW
/*C69*/	{.axis = 5,	.color = LED_CYAN,		.period = LED_TIM_NORM},	//enc5 CW
		{.axis = 5,	.color = LED_DARKCYAN,	.period = LED_TIM_SHORT},	//enc5 CCW
/*C70*/	{.axis = 6,	.color = LED_BLUE,		.period = LED_TIM_NORM},	//enc6 CW
		{.axis = 6,	.color = LED_DARKBLUE,	.period = LED_TIM_SHORT},	//enc6 CCW

...
/*N02*/	{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_YELLOW,.period = LED_TIM_NORM,	.message = "Rate 2"},			//L0M2	SW3
		...
		{.type = TYPE_SWITCH,	.axis = 3,	.color = LED_OFF,	.period = LED_TIM_NORM,	.message = "A3p"},				//L2M3	enc3 push
		{.type = TYPE_SWITCH,	.axis = 4,	.color = LED_OFF,	.period = LED_TIM_NORM,	.message = "A4p"},				//L3M0	enc4 push
...
/*N33*/	{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_RED,	.period = LED_TIM_NORM,	.message = "Auto Tone"},		//L0M1	SW2
		...
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_DARK,	.period = LED_TIM_NORM,	.message = "W/B Auto"},			//L1M1	SW6
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_DARK,	.period = LED_TIM_NORM,	.message = "W/B As Shot"},		//L1M2	SW7
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_BLUE,	.period = LED_TIM_LONG,	.message = "Scene 1"},			//L1M3	SW8 [SCENE]
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_WHITE,	.period = LED_TIM_NORM,	.message = "Reject"},			//L2M0	enc0 push
		...
		{.type = TYPE_SWITCH,	.axis = 6,	.color = LED_DARK,	.period = LED_TIM_NORM,	.message = "Nat-Vibra. reset"},	//L3M2	enc6 push
/*N47*/	{.type = TYPE_SWITCH,	.axis = 7,	.color = LED_OFF,	.period = LED_TIM_NORM,	.message = "A7p"},				//L3M3	enc7 push
...
/*N64*/	{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_WHITE,	.period = LED_TIM_NORM,	.message = "Undo"},				//L0M0	SW1
		...
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_DARK,	.period = LED_TIM_NORM,	.message = "Keyword3"},			//L0M3	SW4
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_DARK,	.period = LED_TIM_NORM,	.message = "Keyword4"},			//L1M0	SW5
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_DARK,	.period = LED_TIM_NORM,	.message = "Keyword5"},			//L1M1	SW6
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_DARK,	.period = LED_TIM_NORM,	.message = "Keyword6"},			//L1M2	SW7
		...
		{.type = TYPE_SWITCH,	.axis = 5,	.color = LED_OFF,	.period = LED_TIM_NORM,	.message = "A5p"},				//L3M1	enc5 push
		{.type = TYPE_SWITCH,	.axis = 6,	.color = LED_OFF,	.period = LED_TIM_NORM,	.message = "A6p"},				//L3M2	enc6 push
		{.type = TYPE_SWITCH,	.axis = 7,	.color = LED_OFF,	.period = LED_TIM_NORM,	.message = "A7p"},				//L3M3	enc7 push
...
/*N96*/	{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_WHITE,	.period = LED_TIM_NORM,	.message = "Undo"},				//L0M0	SW1
		...
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_DARK,	.period = LED_TIM_NORM,	.message = "Upright Full"},		//L0M3	SW4
		...
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_GREEN,	.period = LED_TIM_NORM,	.message = "Upright Vert."},	//L1M2	SW7
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_BLUE,	.period = LED_TIM_LONG,	.message = "Scene 3"},			//L1M3	SW8 [SCENE]
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_WHITE,	.period = LED_TIM_NORM,	.message = "Reject"},			//L2M0	enc0 push
		{.type = TYPE_SWITCH,	.axis = 1,	.color = LED_WHITE,	.period = LED_TIM_NORM,	.message = "Red reset"},		//L2M1	enc1 push

...
/*N15*/	{.axis = 7,	.color = LED_OFF,	.period = LED_TIM_NORM},	//L3M3	enc7 push
		//Scence0 Encoders
/*C40*/	{.axis = 0,	.color = LED_RED,	.period = LED_TIM_SHORT},	//enc0 CW
		{.axis = 0,	.color = LED_RED,	.period = LED_TIM_SHORT},	//enc0 CCW
		{.axis = 1,	.color = LED_BLUE,	.period = LED_TIM_HALF},	//enc1 CW
		{.axis = 1,	.color = LED_BLUE,	.period = LED_TIM_HALF},	//enc1 CCW
		{.axis = 2,	.color = LED_GREEN,	.period = LED_TIM_HALF},	//enc2 CW
...
/*N31*/	{.axis = 7,	.color = LED_OFF,	.period = LED_TIM_NORM},	//L3M3	enc7 push
		//Scence1 Encoders
/*C48*/	{.axis = 0,	.color = LED_RED,	.period = LED_TIM_NORM},	//enc0 CW
		{.axis = 0,	.color = LED_RED,	.period = LED_TIM_NORM},	//enc0 CCW
...
/*N47*/	{.axis = 7,	.color = LED_OFF,	.period = LED_TIM_NORM},	//L3M3	enc7 push
		//Scence2 Encoders
/*C56*/	{.axis = 0,	.color = LED_RED,	.period = LED_TIM_NORM},	//enc0 CW
		{.axis = 0,	.color = LED_RED,	.period = LED_TIM_NORM},	//enc0 CCW
...
/*N63*/	{.axis = 7,	.color = LED_WHITE,	.period = LED_TIM_NORM},	//L3M3	enc7 push
		//Scence3 Encoders
/*C64*/	{.axis = 0,	.color = LED_RED,	.period = LED_TIM_NORM},	//enc0 CW
		{.axis = 0,	.color = LED_RED,	.period = LED_TIM_NORM},	//enc0 CCW

...
const char *scene_name[SCENE_COUNT] = { "Library", "Basic Edits",  "Tone Curve", "Color Bal.", };
...
const KEY_DEFINE keytable[SCENE_COUNT][KEY_DEFINE_COUNT] = {
	{	//Scene0 Button (Library Tab)                                                                   0123456789ABCDEF
		...
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_COLOR_WHITE,	.duration = LED_TIMER_DEFAULT,	.message = "Reject"},			//L2M0	rot0 push
		{.type = TYPE_SWITCH,	.axis = 1,	.color = LED_COLOR_DARK,	.duration = LED_TIMER_DEFAULT,	.message = "C-temp. reset"},	//L2M1	rot1 push
		{.type = TYPE_SWITCH,	.axis = 2,	.color = LED_COLOR_DARK,	.duration = LED_TIMER_DEFAULT,	.message = "Tint reset"},		//L2M2	rot2 push
		...
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_COLOR_OFF,		.duration = LED_TIMER_DEFAULT,	.message = "Keyword 5"},		//L1M0	SW5
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_COLOR_OFF,		.duration = LED_TIMER_DEFAULT,	.message = "Keyword 6"},		//L1M1	SW6
		...
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_COLOR_WHITE,	.duration = LED_TIMER_DEFAULT,	.message = "Reject"},			//L2M0	rot0 push
		{.type = TYPE_SWITCH,	.axis = 1,	.color = LED_COLOR_WHITE,	.duration = LED_TIMER_DEFAULT,	.message = "Black reset"},		//L2M1	rot1 push
		...
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_COLOR_BLUE,	.duration = LED_TIMER_DEFAULT,	.message = "Reject"},			//L2M0	rot0 push
		{.type = TYPE_SWITCH,	.axis = 0,	.color = LED_COLOR_ORANGE,	.duration = LED_TIMER_DEFAULT,	.message = "Red reset"},		//L2M1	rot1 push
		{.type = TYPE_SWITCH,	.axis = 4,	.color = LED_COLOR_WHITE,	.duration = LED_TIMER_DEFAULT,	.message = "Orange reset"},		//L2M2	rot2 push
		{.type = TYPE_SWITCH,	.axis = 5,	.color = LED_COLOR_WHITE,	.duration = LED_TIMER_DEFAULT,	.message = "Yellow reset"},		//L2M3	rot3 push
		{.type = TYPE_SWITCH,	.axis = 1,	.color = LED_COLOR_WHITE,	.duration = LED_TIMER_DEFAULT,	.message = "Green reset"},		//L3M0	rot4 push

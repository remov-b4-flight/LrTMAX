...
{
#if 1
	0x09, CONFIG, 83, 0, NUM_INTF, CONFIG1, UNUSED_DESC_IDX, BUSPOWERED, MIDI_POWER,
	0x09, INTERFACE, INTF0, ALTER0, MS_NUM_EP, AUDIO, MIDI_STREAM, MIDI_UNUSED, MIDI_UNUSED,
	0x07, CS_INTERFACE, HEADER, 0x00, 0x01, 37, 0,	 											// Class-Specific MS Interface Header Descriptor
	...
	0x09, CONFIG, 86, 0, NUM_INTF, CONFIG1, UNUSED_DESC_IDX, (BUSPOWERED | REMOTE_WAKEUP) , MIDI_POWER,
	...
	// MIDI IN JACKS
	0x06, CS_INTERFACE, MIDI_IN_JACK, MIDI_JACK_ENB, MIDI_IN_JACK_NO, UNUSED_DESC_IDX,
	// MIDI OUT JACKS
	0x09, CS_INTERFACE, MIDI_OUT_JACK, MIDI_JACK_ENB, MIDI_OUT_JACK_NO, 0x01, 0x01, 0x01, UNUSED_DESC_IDX,
	// IN EP descriptor
	0x09, ENDPOINT, MIDI_IN_EP, BULK, 64, 0, INTERVAL, MIDI_UNUSED, MIDI_UNUSED,

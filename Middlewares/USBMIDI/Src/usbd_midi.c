...
__ALIGN_BEGIN uint8_t USBD_MIDI_CfgDesc[USB_MIDI_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x09, CONFIG, 68/*83*/, 00, 0x01, CONFIG1, 0x00, BUSPOWERED, MIDI_POWER,

  // The Audio Interface Collection
  0x09, INTERFACE	, INTF0,  0x00, 0x02, AUDIO, MIDI_STREAM, MIDI_UNUSED, MIDI_UNUSED,	// MIDIStreaming Interface Descriptors
  0x07, CS_INTERFACE, HEADER, 0x00, 0x01, 40/*65*/, 00,   								// Class-Specific MS Interface Header Descriptor

  // MIDI IN JACKS
  0x06, CS_INTERFACE, MIDI_IN_JACK, MIDI_JACK_ENB, 0x01, NO_STRING_IDX,//MIDI-IN 1 (embedded)
#if 0
  0x06, CS_INTERFACE, MIDI_IN_JACK, MIDI_JACK_EXT, 0x02, MIDI_UNUSED,//MIDI-IN 1 (external)
#endif
  // MIDI OUT JACKS
  0x09, CS_INTERFACE, MIDI_OUT_JACK, MIDI_JACK_ENB, 0x03, 0x01, 0x02, 0x01, NO_STRING_IDX,//MIDI-OUT 1 (embedded)
#if 0
